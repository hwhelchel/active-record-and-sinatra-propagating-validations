class Event < ActiveRecord::Base
  ...
  validates_presence_of :date, :title, :organizer_name, message: "is required."
  validates_format_of :date, with: DATE_REGEX
  validate :event_date_cannot_be_in_past
  validates_format_of :organizer_email, with: EMAIL_REGEX, message: "must be a valid email address."
